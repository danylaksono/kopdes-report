...
This is B1 of `analytics-plan.md`: *how many KDMP are built close enough to
each other that they compete for the same population?* The plan proposed an
...
- **19** have impossible coordinates (08's lat-sign flips and the Papua garbage
  point);
- **802** share an *exact duplicate coordinate* with another cooperative — 388
...
| Size | Where | Notes |
|---|---|---|
| **17** | PAPUA PEGUNUNGAN, Kab. Jayawijaya (Wamena area) | 17 *recorded* at one spot, ~1 km cell |
...
the same *badly sited or badly geocoded* ambiguity as 04: a cluster of 17
...
The plan's B1 hypothesis — *clustered KDMP have lower per-unit transaction
volumes* — **is not supported**. Cooperatives that share a cell report at the
...
- "Co-located" here means *recorded at* the same cell, not *built* there. The
